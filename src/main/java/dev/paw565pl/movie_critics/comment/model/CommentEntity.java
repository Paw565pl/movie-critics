...
@Table(
        name = "comments",
        indexes = {@Index(name = "one_comment_for_movie_per_user", columnList = "user_id, movie_id", unique = true)})
public class CommentEntity {
    ...
    @NonNull @Column(name = "text", columnDefinition = "TEXT", nullable = false)
    private String text;
